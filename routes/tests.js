 ...
 * 
 * @apiName GetTestsByLevel&Category&AttemptsRemaining
 * 
 * @apiGroup Tests
 * 
 * @apiParam (Number) input Test batch Level Category AttemptsRemaining to pull
 * 
 * @apiSuccess (JSON) data Current table entry for test
 * @apiSuccess (JSON) responseCode HTTP Response Code
 * @apiSuccess (JSON) response Server Response
...
/**
 * @api (get) /tests/operation/:operation
 * 
 * @apiName GetTestsByOperation
 * 
 * @apiGroup Tests
 * 
 * @apiParam (Number) input Test batch operation to pull
 * 
 * @apiSuccess (JSON) data Current table entry for test
 * @apiSuccess (JSON) responseCode HTTP Response Code
 * @apiSuccess (JSON) response Server Response
...
router.get('/operation/:operation', function (req, res) {
    var result = {};
    data.Test.findAll({
        where: {
        ...
        .then(testData => {
            ...
            result['data'] = parsed;
            result['endpoint'] = `/tests/operation/:operation`;
            result['responseCode'] = HttpStatus.OK;
            result['response'] = "Query Successful";
            res.status(result.responseCode);
            res.json(result);
...
/**
 * @api (get) /tests/operation/:operation/baseNumber/:baseNumber
 * 
 * @apiName GetTestsByOperation&BaseNumber
 * 
 * @apiGroup Tests
 * 
 * @apiParam (Number) input Test batch operation & baseNumber to pull
 * 
 * @apiSuccess (JSON) data Current table entry for test
 * @apiSuccess (JSON) responseCode HTTP Response Code
 * @apiSuccess (JSON) response Server Response
...
router.get('/operation/:operation/baseNumber/:baseNumber', function (req, res) {
    var result = {};
    data.Test.findAll({
        where: {
            operation: req.params.operation,
        ...
        .then(testData => {
            ...
            result['data'] = parsed;
            result['endpoint'] = `/tests/operation/:operation/baseNumber/:baseNumber`;
            result['responseCode'] = HttpStatus.OK;
            result['response'] = "Query Successful";
            res.status(result.responseCode);
            res.json(result);
